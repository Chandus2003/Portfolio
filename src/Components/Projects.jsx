  ...
  const projects = [
    {
      ...
      demo: "https://crm-app-demo.vercel.app"
    },
    {
      name: "Pokedex",
      ...
      demo: "https://pokedex-demo.vercel.app"
    },
    {
      name: "News Portal",
      ...
      github: "https://github.com/yourusername/news-portal",
      demo: "https://news-portal-demo.vercel.app"
    },
  ];
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((proj, idx) => (
            <div
              key={idx}
              className="group bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-700"
            >
              {/* Colored Top Bar */}
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-200 font-medium">{proj.stack}</p>
                </div>
